...
// Fetches and stores the Minotor RAPTOR binaries (timetable.bin + stops.bin)
// for offline routing, stamping downloadedAt in lockstep (offlineRouter.ts's
// cache key depends on that pairing). Generated by the pipeline (see
